...
function Question2() {
    ...
    return (
        <div className='container mt-5'>
            <h5 className='m-2'>2)Create a component to render table and unordered list for the following array</h5>
            <h3>With using Props</h3>
            <Posts myPost={posts}></Posts>
